      ...
      pw.Page(
        ...
        build: (ctx) => pw.Column(
          ...
          children: [
            ...
            pw.Row(
              children: [
                pw.Text('طريقة الدفع: ', style: pw.TextStyle(font: arabicFontBold, fontSize: 12), textDirection: pw.TextDirection.rtl),
                pw.Text(paymentType, style: pw.TextStyle(font: arabicFont, fontSize: 12), textDirection: pw.TextDirection.rtl),
              ],
            ),
