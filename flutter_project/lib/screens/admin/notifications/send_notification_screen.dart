...
class _SendNotificationScreenState extends State<SendNotificationScreen> {
  ...
  final _notifDao = NotificationDao();
  ...
  Future<void> _send() async {
    ...
    switch (_targetType) {
      case 'all':
        // Send to all users and all customers using role-based approach
        await _notifDao.sendToAll(
      ...
      case 'all_partners':
        await _notifDao.sendToRole(
          userRole: AppConstants.rolePartner,
          title: _titleCtrl.text.trim(),
          body: _bodyCtrl.text.trim(),
        );
