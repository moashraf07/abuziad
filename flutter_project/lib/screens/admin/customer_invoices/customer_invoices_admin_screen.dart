                          ...
                          Expanded(child: OutlinedButton.icon(
                            ...
                            onPressed: () async {
                              ...
                              PushNotificationService.sendToCustomer(
                                ...
                                title: NotifMsg.invoiceRejectedTitle,
                                body: NotifMsg.invoiceRejectedBody,
                                type: 'invoice',
                                referenceId: inv.id,
                          ...
                          Expanded(child: ElevatedButton.icon(
                            ...
                            onPressed: () async {
                              ...
                              PushNotificationService.sendToCustomer(
                                ...
                                body: NotifMsg.invoiceApprovedBody,
                                type: 'invoice',
                                referenceId: inv.id,
                                referenceType: 'invoice',
                              );
                        ...
                        if (inv.status == 'approved')
                          Expanded(child: ElevatedButton.icon(
                            ...
                            onPressed: () async {
                              ...
                              PushNotificationService.sendToCustomer(
                                customerId: inv.customerId,
                                title: NotifMsg.invoiceDeliveredTitle,
                                body: NotifMsg.invoiceDeliveredBody,
                                type: 'invoice',
                                referenceId: inv.id,
                                referenceType: 'invoice',
                              );
